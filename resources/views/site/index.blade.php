...
<body>
    ...
    <section class="position-relative">
        <img src="user/img/banner.webp" alt="Banner Principal" class="w-100">
            ...
            <div class="row">
                <div class="col-4">
                    <div class="d-flex align-items-center h-100 rounded overflow-hidden" style="background-color: #FFE8BA;">
                        <img src="user/img/cartoon-dog.webp" alt="Cachorro em desenho animado" width="130">
                ...
                <div class="col-4">
                    <div class="d-flex align-items-center h-100 rounded overflow-hidden" style="background-color: #DC9AFE;">
                        <img src="user/img/cartoon-cat.webp" alt="Gato em desenho animado" width="130">
                        <p class="m-0 p-3 h-100 d-flex align-items-center bg-white">
                ...
                <div class="col-4">
                    <div class="d-flex align-items-center h-100 rounded overflow-hidden" style="background-color: #84FBFF;">
                        <img src="user/img/cartoon-cat-2.webp" alt="Gato em desenho animado" width="130">
                        <p class="m-0 p-3 h-100 d-flex align-items-center bg-white">
