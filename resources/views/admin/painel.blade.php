                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-center">
                                    ...
                                    <a href="{{ route('users.edit', ['user' => $user->id_user ]) }}" class="btn btn-light d-flex justify-content-center align-items-center rounded-circle p-2 mx-2" title="Editar">
                                    ...
                                    <a href="{{ route('users.destroy', ['user' => $user->id_user ]) }}" class="btn btn-danger d-flex justify-content-center align-items-center rounded-circle p-2 mx-2" title="Deletar">
